...
import { DetailRow, MileageChart, MOTPassFailBars, MOTTestCard, RecurringIssueItem, icons } from "@/components/sections/shared";

export default function EVHistorySections({ mot_summary, clocking_analysis, mileage_timeline, failure_patterns, mot_tests, vehicle }: {
      ...
      {clocking_analysis && (
        ...
        >
          ...
          {clocking_analysis.reason && (
            <p className="text-sm text-slate-500 mb-2">{clocking_analysis.reason}</p>
          )}
