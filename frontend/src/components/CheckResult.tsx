            ...
            <div className="mb-3">
              {clocking_analysis.clocked ? (
                <div className="flex items-center gap-2 bg-red-50 border border-red-200 rounded-lg px-3 py-2">
                  ...
                  <span className="text-sm font-semibold text-red-800">CLOCKING DETECTED</span>
                </div>
              ) : clocking_analysis.risk_level === "none" ? (
                <div className="flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded-lg px-3 py-2">
                  <svg className="w-5 h-5 text-emerald-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <span className="text-sm font-semibold text-emerald-800">No Clocking Detected</span>
                </div>
              ) : (
                <Badge
                  variant={
