    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white flex flex-col">
      ...
      <section className="mx-auto max-w-3xl px-4 py-16 w-full flex-1">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-sm text-slate-600 leading-relaxed">
          ...
          <p>
            Some reports include summaries, analysis, or commentary generated by artificial intelligence
            systems (large language models). These AI-generated elements are produced programmatically from
            the underlying vehicle data.
          </p>
          <p>AI-generated content:</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>Is a best-effort interpretation, not a professional assessment</li>
            <li>May contain factual errors, misrepresentations, or inconsistencies with the underlying data</li>
            <li>May emphasise, de-emphasise, or omit details</li>
          ...
          <p>
            AI-generated content must not be relied upon as mechanical, legal, or financial advice. Where
            AI commentary and raw data disagree, the raw data from the underlying sources (DVLA, DVSA,
            Experian, etc.) takes precedence. You should always have a qualified mechanic inspect any
